 ...
 */
public class ImprovedGraphModel {
        //邻接矩阵类
        static final double maxWeight= -1; //如果两个结点之间没有边，权值为-1；
        ArrayList<String> vertices = new ArrayList<String>();//存放结点的集合
        double[][] edges; //邻接矩阵的二维数组
        ...
        int numOfEdges; //边的数量
        double [][] maxKEdges;//最大的k个权值
        public ImprovedGraphModel(int n)
        {
        ...
        //获得某条边的权值
        public double getWeightOfEdges(int v1,int v2) throws Exception
        {
        ...
        //获取每一列的值
        public ArrayList<Double> getSumOfCol(){
        ...
        //获得所有边的权值之和
        public double getWeightOfAllEdges() throws Exception
        {
            double weightSum = 0;
        ...
        //插入带权值的边
        public void insertEdges(int v1,int v2,double weight) throws Exception
        {
            if((v1 < 0 || v1 >= vertices.size())||(v2 < 0||v2 >= vertices.size()))
            {
                throw new Exception("v1或者v2参数越界错误！");
        ...
        //获得邻接矩阵中每个节点的度
        public HashMap<Integer, Double> getPointWeightSum()
        {
            HashMap<Integer, Double> pointWeight = new HashMap<Integer, Double>();
    ...
    public static void main(String[] args) {
        int n=5; //5个结点
        int e=5; //5条边
        ImprovedGraphModel g = new ImprovedGraphModel(n);
        String[] vertices = new String[]{new String("A"),new String("B"),new String("C"),new String("D"),new String("E")};
        ImprovedWeight[] weights = new ImprovedWeight[]{new ImprovedWeight(0,1,10),new ImprovedWeight(0,4,20),new ImprovedWeight(2,1,40),new ImprovedWeight(1,3,30),new ImprovedWeight(3,2,50)};

        try
        {
            ImprovedWeight.createAdjGraphic(g, vertices, n, weights, e);
